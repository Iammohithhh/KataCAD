...
// Layer 3 retrieved part. Heroes build locally and animate; Layer 2/3 parts
// are generated by the API, imported as STEP, and rendered statically. All
// three flow through the same viewport, feature tree, sliders and export.
...
/** A shape that can be exported — heroes and generated parts both provide one. */
  ...
  const handlePrompt = async (prompt: string): Promise<void> => {
    ...
    try {
      ...
      if (result.layer === 2 && result.archetype) {
        ...
        // Seed the scale slider at 1.0 so it shows the part's actual size.
